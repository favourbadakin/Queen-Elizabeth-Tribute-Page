        ...
        <div className='flex flex-col md:gap-x-14 md:flex-row'>
            <div className='md:w-[40%] lg:w-full mb-4'>
                <div className='flex flex-col xl:flex-row gap-x-6'>
                    <img src={buhari} data-aos='zoom-in-right' className='object-contain sm:object-cover' alt='president'/>
            ...
            <div className='md:w-[40%] lg:w-full'>
                <div className='flex flex-col xl:flex-row gap-x-6'>
                    <img src={macron} data-aos='zoom-in-left' className='object-contain sm:object-cover h-full' alt='president'/>
