    ...
    <section className='bg-hero-image pt-4 px-4 md:px-[11rem] overflow-x-hidden' id='timeline'>
        <div>
            ...
            <div className='hidden xl:block'>
                <span><a href='https://en.wikipedia.org/wiki/Elizabeth_II' className='flex items-center font-bold hover:underline'>See All<TiArrowRight /></a></span>
            </div>
            </div>
            <div>
        ...
        <div className='grid gap-y-8 lg:gap-y-0 lg:grid-cols-3 lg:gap-x-6'>
            <div className='border-x p-4' data-aos='fade-up'>
            ...
            <div className='border-x p-4' data-aos='fade-down'>
